# P06 Lifecycle Integrity and Roadmap: Intent
...
The primary reviewer is a senior applied-AI or platform engineer checking whether the repository's method claims agree with its artifacts. The reviewer should be able to verify:
...
- Reconcile stale lifecycle statuses and checklists.
...
- Building P07–P11.
- Claiming hosted, live-provider, production, operational, mobile, or store evidence that does not exist.
- Rewriting the disclosed P02 adoption sequence.
- Publishing a new release or changing repository visibility.
- Changing current application behavior.

## Constraints

- Preserve historical evidence and exact limitations.
...
- All status contradictions identified in P02–P04 are resolved.
- README, lifecycle guide, roadmap, issues, and P06 packet agree.
- Every planned phase has a live issue and acceptance boundary.
- Documentation and current-head review gates pass.
