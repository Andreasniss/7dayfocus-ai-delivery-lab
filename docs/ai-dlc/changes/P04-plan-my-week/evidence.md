...
- GitHub-hosted Actions cannot provide current evidence because the account's
  Actions budget is exhausted. Local and isolated clean-copy gates passed; this
  does not claim equivalent hosted execution.
