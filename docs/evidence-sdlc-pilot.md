...
This repository is the initial source home of the independently installable `skills/evidence-sdlc` bundle. Runbook Relay pilots the same bundle with different repository-owned commands. The P12 change packet records the scope and implementation plan.
