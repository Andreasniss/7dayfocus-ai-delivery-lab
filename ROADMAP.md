...
| 2 | [P11 · Android personal install](https://github.com/Andreasniss/7dayfocus-ai-delivery-lab/issues/17) | Reuse the earlier Tauri/Android proof where useful, install a current build on Andreas's phone, and record a device test | Physical-device outcome verified 2026-09-06 on Pixel 8 Pro / Android 17; Android export limitation disclosed; final PR gates tracked in #19; optional Play spike not started |
