...
| 2 | [P11 · Android personal install](https://github.com/Andreasniss/7dayfocus-ai-delivery-lab/issues/17) | Reuse the earlier Tauri/Android proof where useful, install a current build on Andreas's phone, and record a device test | In progress; fixture-only API 36 project and ARM64 debug APK build passed, phone install/checklist open; Google Play spike capped at three hours |
